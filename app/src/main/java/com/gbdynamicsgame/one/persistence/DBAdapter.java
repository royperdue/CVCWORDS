package com.gbdynamicsgame.one.persistence;
...
import com.gbdynamicsgame.one.model.UserData;
...
public class DBAdapter
{
    ...
    /** Create table syntax */
    private static final String USER_CREATE = "create table tbl_user(_id integer primary key autoincrement, package_name text not null, user_data text not null);";
    ...
    public static void addUserData(UserData uData)
    {
        ...
        String email = sqlEscapeString(uData.getData());

        ContentValues cVal = new ContentValues();

        cVal.put(KEY_PACKAGE_NAME, name);
        cVal.put(KEY_USER_DATA, email);
    ...
    public static UserData getUserData(int id)
    {
        ...
        Cursor cursor = db.query(USER_TABLE, new String[]
                        {KEY_ID, KEY_PACKAGE_NAME, KEY_USER_DATA}, KEY_ID + "=?",
                new String[]
    ...
    public static int updateUserData(UserData data)
    {
        ...
        values.put(KEY_PACKAGE_NAME, data.getName());
        values.put(KEY_USER_DATA, data.getData());

        // updating row
        return db.update(USER_TABLE, values, KEY_ID + " = ?", new String[]
    ...
    {
        final SQLiteDatabase db = open();
        db.delete(USER_TABLE, KEY_ID + " = ?", new String[]
                {String.valueOf(data.getID())});
        db.close();
    }
