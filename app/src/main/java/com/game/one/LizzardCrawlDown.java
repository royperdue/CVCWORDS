...
public class LizzardCrawlDown extends Sprite
{
    ...
    public LizzardCrawlDown(GameView view, Context context)
    {
        super(view, context);

        this.x = ((Util.PIXEL_WIDTH / 4) - (Util.PIXEL_WIDTH / 20));
