...
public class FlyE extends Sprite
{
	public String flyId = "";
	...
	public FlyE(GameView view, Context context, String id, boolean spitOut)
	{
		super(view, context);
